...
void leftSide(bool is_red_team)
{
  ...
  chassis.moveToPoint(24.75-.5, -100.0, 1200, {.maxSpeed = 60, .minSpeed = 20}, false);

  // ! Attempt to score
  auto after_loader = chassis.getPose();
  chassis.moveToPoint(
      after_loader.x -1.3-.5, after_loader.y + 36.0, 1800, {.forwards = false, .maxSpeed = 45});
  pros::delay(600);
 ...
 intake.setState(Intake::states::SCORING);
  ...
  // ? Grab Middle
  intake.setState(Intake::states::SCORING);
  chassis.moveToPose(42, 34, 90, 2000, {.lead = 0.9, .minSpeed = 20}, false);
  intake.setState(Intake::states::STORING);
  ...
  // ! Score Middle
  chassis.turnToHeading(48 + 179+1.5, 1000, {}, false);
...
void rightSide(bool is_red_team)
{
 ...
 //chassis.moveToRelativePoint(Chassis::fromPolar(3, 0), 1200, {.maxSpeed = 100}, false);
  ...
  chassis.turnToHeading(-44-12-2, 500, {}, false);
  chassis.moveToRelativePoint(Chassis::fromPolar(15, -44-12-2), 1200, {.maxSpeed = 80}, false);
  intake.setState(Intake::states::OUTTAKE);

  chassis.moveToRelativePoint(Chassis::fromPolar(-4.5, -44-12-2), 1200, {.maxSpeed = 127}, false);
  chassis.moveToRelativePoint(Chassis::fromPolar(4, -44-12-2), 1200, {.maxSpeed = 80}, false);
...
void skills(bool is_red_team)
{
  ...
  // UNLOAD GOAL 1
  matchload_unloader.extend();
  chassis.moveToPoint(24.-5.75, 23.25, 2000, {}, false);

  // Grab Blocks
  chassis.turnToHeading(-180, 1000, {}, false);
  chassis.moveToPoint(24.5-0.5-5.75, -100.0, 2500, {.maxSpeed = 50, .minSpeed = 20}, false);
  ...
  chassis.turnToHeading(0, 1800, {}, false);
...
//   chassis.moveToPoint(23, 120, 2000, {}, false);
